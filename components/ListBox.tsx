...
import { CatalogData, CatalogDataProvider, Categories } from "@/app/providers";
...
export const PullRequestIcon = (props: { className?: string }) => {
  return (
    <svg height="1em" viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const ChatIcon = (props: { className?: string }) => {
  return (
    <svg height="1em" viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const PlayCircleIcon = (props: { className?: string }) => {
  return (
    <svg height="1em" viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const WatchersIcon = (props: { className?: string }) => {
  return (
    <svg height="1em" viewBox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
function IconPicker({ i }: { i: number }) {
  switch (i % 6) {
    case 0:
      return <BugIcon className="text-lg " />;
    case 1:
      return <PullRequestIcon className="text-lg " />;
    case 2:
      return <ChatIcon className="text-lg " />;
    case 3:
      return <PlayCircleIcon className="text-lg " />;
    case 4:
      return <LayoutIcon className="text-lg " />;
    case 5:
      return <BookIcon className="text-lg " />;
    default:
      return <BugIcon className="text-lg " />;
  }
}
...
export function DisplayCategory({ category, i }: { category: ReturnType<typeof useGetCategories>[0]; i: number }) {
  return (
    <ListboxItem
        ...
        startContent={
          <IconWrapper className={"bg-success/10 text-" + color[i % color.length]}>
            <IconPicker i={i} />
          </IconWrapper>
        }
  ...
  return (
    ...
    >
      {...categories.map((category, i) => (
        <ListboxItem
        key={category["@id"]}
        endContent={<ItemCounter number={instanceLookup[category['@id']!].length} />}
        startContent={
          <IconWrapper className={"bg-success/10 text-" + color[i % color.length]}>
            <IconPicker i={i} />
          </IconWrapper>
